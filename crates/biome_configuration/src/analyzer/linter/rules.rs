...
impl RuleName {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::UseConsistentBooleanProps => "useConsistentBooleanProps",
    ...
    pub const fn group(self) -> RuleGroup {
        match self {
            ...
            Self::UseConsistentBooleanProps => RuleGroup::Nursery,
...
impl std::str::FromStr for RuleName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "useConsistentBooleanProps" => Ok(Self::UseConsistentBooleanProps),
...
impl RuleGroupExt for Nursery {
    ...
    fn get_enabled_rules(&self) -> FxHashSet<RuleFilter<'static>> {
        ...
        if let Some(rule) = self.use_consistent_boolean_props.as_ref()
            && rule.is_enabled()
        {
            index_set.insert(RuleFilter::Rule(Self::GROUP_NAME, Self::GROUP_RULES[26]));
        }
    ...
    fn get_rule_configuration(
        ...
        match rule_name {
            ...
            "useConsistentArrowReturn" => self
                ...
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
            "useConsistentBooleanProps" => self
                .use_consistent_boolean_props
                .as_ref()
                .map(|conf| (conf.level(), conf.get_options())),
...
impl From<GroupPlainConfiguration> for Nursery {
    fn from(value: GroupPlainConfiguration) -> Self {
        Self {
            ...
            use_consistent_boolean_props: Some(value.into()),
